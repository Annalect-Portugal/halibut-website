...
import desktopHomeBanner from '../assets/banners/irritacoes/desktop.png';
import mobileHomeBanner from '../assets/banners/irritacoes/mobile.png';
...
const Irritacoes = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Gama Irritações - Halibut</title>
      </Helmet>
      <Banner image={desktopHomeBanner} mobileImage={mobileHomeBanner} />
      <Title title={"Irritações da Pele"} subtitle={"Qualidade garantida, geração a geração"} />
